...
This folder contains all the elements of the tools and additionnaly all files that allow to launch it on the Kink-Turn family and evaluate it. Such folder aims specifically to allow a uset to reproduce the benchmarks that were used in (TODO lien arXiV?) by Boury et al, 2023 
...
* All task that contains examples are mostly suited to our Kink-Turn benchmark and will need additional adaptations to work with others families of RNAs.
